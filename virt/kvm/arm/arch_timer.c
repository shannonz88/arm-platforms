...
void kvm_timer_flush_hwstate(struct kvm_vcpu *vcpu)
{
	...
	if (timer->irq_active)
		irq_set_fwd_state(host_vtimer_irq, IRQ_FWD_STATE_ACTIVE,
				  timer->irq_active);
}
...
void kvm_timer_sync_hwstate(struct kvm_vcpu *vcpu)
{
	...
	timer->irq_active = irq_get_fwd_state(host_vtimer_irq,
					      IRQ_FWD_STATE_ACTIVE);
	if (timer->irq_active)
		irq_set_fwd_state(host_vtimer_irq, IRQ_FWD_STATE_ACTIVE, 0);
